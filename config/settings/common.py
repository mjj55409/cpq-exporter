# -*- coding: utf-8 -*-
"""
Django settings for cpq-exporter project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'cpq_exporter.contrib.sites.migrations'
}
...
ADMINS = (
    ("""Michael Josephson""", 'michael@mertisconsulting.com'),
)
...
ACCOUNT_ADAPTER = 'cpq_exporter.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'cpq_exporter.users.adapters.SocialAccountAdapter'
